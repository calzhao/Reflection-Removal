...
if __name__ == '__main__':
    ...
    eval_dataset_ceilnet = datasets.CEILTestDataset(join(datadir, 'crop20'),enable_transforms=False)
    ...
    res = engine.eval(eval_dataloader_ceilnet, dataset_name='testdata_table1', savedir=join(result_dir, 'two_sync_20'))
