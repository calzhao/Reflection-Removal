...
class ERRNetModel(ERRNetBase):
    ...
    def initialize(self, opt):
        ...
        # reflection estimation net
        self.net_r = arch.__dict__[self.opt.inet](in_channels, 3).to(self.device)
        ...
        if self.isTrain:
            ...
            self.optimizer_G = torch.optim.Adam(itertools.chain(self.net_i.parameters(), self.net_r.parameters()), 
    ...
    def backward_G(self):
        ...
        if self.aligned:
            ...
            self.loss_G += self.loss_icnn_pixel_r+self.loss_icnn_remake*2
        else:
